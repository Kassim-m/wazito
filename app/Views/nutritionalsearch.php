...
<head>
  ...
  <title>Nutritional Search - Wazito Kitchen</title>
</head>
  <style>
...
<header>
  ...
  <section id="content">
    ...
    <div class="search-container">
      <input type="text" id="caloriesInput" placeholder="Enter maximum calories...">
      <input type="text" id="proteinInput" placeholder="Enter minimum protein...">
      <button onclick="searchRecipesByNutrition()">Search</button>
    </div>
  </section>
  <script>
    ...
    document.getElementById('nutritionalSearch').addEventListener('click', function(event) {
      event.preventDefault();
      document.getElementById('content').innerHTML = `
        <div class="search-container">
          <input type="text" id="caloriesInput" placeholder="Enter maximum calories...">
    ...
    function searchRecipesByNutrition() {
      const maxCalories = document.getElementById('caloriesInput').value;
      const minProtein = document.getElementById('proteinInput').value;
      fetch(`https://api.spoonacular.com/recipes/findByNutrients?apiKey=f7da9345087242f2980c0e0bec71c97f&maxCalories=${maxCalories}&minProtein=${minProtein}`)
        .then(response => response.json())
        .then(data => {
          const recipes = data;
          let html = '';
